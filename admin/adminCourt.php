...
<html lang="en">
    ...
    <body >
        ...
        <div class="container-fluid" style="background-color: #00004d;">
            <div class="container d-flex justify-content-center align-items-center" style="height: 30vh;">
                ...
                <h1 class="text-light"><strong>ADMIN PAGE:</strong></h1>
                    <h2 class="text-light">Booking Details For Court</h2>
                </div>
            </div>
        </div>
        <?php
        ...
        $total_sql = "SELECT COUNT(*) FROM booking_court";
        ...
        $sql = "SELECT 
                    booking_court.booking_id,
                    booking_court.timeSlot,
                    booking_court.date,
                    user.userName
                FROM 
                    booking_court
                LEFT JOIN 
                    user 
                ON 
                    booking_court.userMatrix = user.userMatrix
                ORDER BY 
                    booking_court.date DESC
