...
<html lang="en">
    ...
    <body >
        ...
        <div class="container-fluid" style="background-color: #00004d;">
            <div class="container d-flex justify-content-center align-items-center" style="height: 30vh;">
                ...
                <h1 class="text-light"><strong>ADMIN PAGE:</strong></h1>
                    <h2 class="text-light">Booking Details For gym</h2>
                </div>
            </div>
        </div>
        <?php
        ...
        $total_sql = "SELECT COUNT(*) FROM booking_gym";
        ...
        $sql = "SELECT 
                    booking_gym.booking_id,
                    booking_gym.timeSlot,
                    booking_gym.date,
                    user.userName
                FROM 
                    booking_gym
                LEFT JOIN 
                    user 
                ON 
                    booking_gym.userMatrix = user.userMatrix
                ORDER BY 
                    booking_gym.date DESC
