...
<html lang="en">
    ...
    <body>
        ...
        <div class="container my-5 border p-3">
            ...
            $date = $_GET['date'];
            $sql = "SELECT booking_court.booking_id, booking_court.timeSlot, booking_court.userMatrix, booking_court.date, user.userName, user.userMatrix, user.userNoTel
                    FROM booking_court
                    INNER JOIN user ON user.userMatrix = booking_court.userMatrix
                    WHERE booking_court.userMatrix = ? AND booking_court.date >= CURRENT_DATE";
