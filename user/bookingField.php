        ...
        <div class="container-fluid" style="background-color: #00004d;">
            ...
            <div class="container d-flex justify-content-center align-items-center" style="height: 50vh;">
                <div class="text-center">
                    ...
                    <h4 class="text-light text-montserrat">Football Field</h4>
                </div>
            </div>
        </div>
        ...
        <div class="container mt-4">
            ...
            <div class="col-md-12">
                ...
                function build_calendar($month, $year) {
                    include("../conn.php");
                    $stmt = $conn->prepare("SELECT * FROM booking_field WHERE MONTH(date) = ? AND YEAR(date) = ?");
                    ...
                    while ($currentDay <= $numberDays) {
                        ...
                        if ($dayname == 'friday' || $dayname == "saturday") {
                            ...
                            if ($totalbookings == 3) {
                                ...
                                $calendar .= "<td class='$today'><h4>$currentDay</h4> <a href='popField.php?date=" . $date . "' class='btn btn-warning btn-sm'>BOOK</a>";
                            } elseif ($totalbookings == 1) {
                                $calendar .= "<td class='$today'><h4>$currentDay</h4> <a href='popField.php?date=" . $date . "' class='btn btn-info btn-sm'>BOOK</a>";
                            } else {
                                $calendar .= "<td class='$today'><h4>$currentDay</h4> <a href='popField.php?date=" . $date . "' class='btn btn-success btn-sm'>BOOK</a>";
                            }
                        }
                ...
                function checkSlots($conn, $date) {
                    $stmt = $conn->prepare("SELECT * FROM booking_field WHERE date = ?");
