...
if(isset($_POST['submit'])){
    ...
    $timeslot = $_POST['timeslot'];
      $stmt = $conn -> prepare("select*from booking_court where date = ? AND timeSlot = ?");
    ...
    if($stmt->execute()){
        ...
        if($result->num_rows>0){
            $msg = "<div class='alert alert-danger'>Already Booked</div>";
             ...
             $stmt = $conn->prepare("INSERT INTO booking_court (timeSlot, userMatrix, date) VALUES (?,?,?)");
...
<html lang="en">
    ...
    <body>
        ...
        <div class="container my-4 text-center form-control shadow">
            ...
            <br>
            <br>
            <a href="bookingCourt.php" class="btn btn-secondary mb-3">Back</a>
    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content popup-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Book Court</h5>
