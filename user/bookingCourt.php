...
<html lang="en">
    ...
    <body>
        ...
        <div class="container-fluid" style="background-color: #00004d;">
            ...
            <div class="container d-flex justify-content-center align-items-center" style="height: 30vw;">
                <div class="text-center">
                    <h1 class="fw-bold text-light" style="font-size: 50px !important;">Booking</h1>
                    <h4 class="text-light text-montserrat">Court</h4>
                </div>
            </div>
        </div>
        ...
        <div class="container mt-4">
            ...
            <div class="col-md-12">
                ...
                function build_calendar($month, $year) {
                    include("../conn.php");
                    $stmt = $conn->prepare("SELECT * FROM booking_court WHERE MONTH(date) = ? AND YEAR(date) = ?");
                    ...
                    while ($currentDay <= $numberDays) {
                        ...
                        if ($dayname == 'friday' || $dayname == "saturday") {
                            ...
                            if ($totalbookings == 3) {
                                ...
                                $calendar .= "<td class='$today'><h4>$currentDay</h4> <a href='popCourt.php?date=" . $date . "' class='btn btn-warning btn-sm'>BOOK</a>";
                            } elseif ($totalbookings == 1) {
                                $calendar .= "<td class='$today'><h4>$currentDay</h4> <a href='popCourt.php?date=" . $date . "' class='btn btn-info btn-sm'>BOOK</a>";
                            } else {
                                $calendar .= "<td class='$today'><h4>$currentDay</h4> <a href='popCourt.php?date=" . $date . "' class='btn btn-success btn-sm'>BOOK</a>";
                            }
                        }
                ...
                function checkSlots($conn, $date) {
                    $stmt = $conn->prepare("SELECT * FROM booking_court WHERE date = ?");
