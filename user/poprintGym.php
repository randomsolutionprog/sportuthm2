...
<html lang="en">
    ...
    <body>
        ...
        <div class="container my-5 border p-3">
            ...
            $date = $_GET['date'];
            $sql = "SELECT booking_gym.booking_id, booking_gym.timeSlot, booking_gym.userMatrix, booking_gym.date,  user.userName, user.userMatrix, user.userNoTel
                    FROM booking_gym
                    INNER JOIN user ON user.userMatrix = booking_gym.userMatrix
                    WHERE booking_gym.userMatrix = ? AND booking_gym.date >= CURRENT_DATE";
